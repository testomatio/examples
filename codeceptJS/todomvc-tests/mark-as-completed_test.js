Feature('Mark as completed/not completed @step-06 @Sdb973f80')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed @Teec604dd', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos @Tac853700', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed @Te8793ba1', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos @T0d06937c', async ({ I, TodosPage }) => {
